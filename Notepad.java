...
//            FileNameExtensionFilter restrect = new FileNameExtensionFilter("Only .txt files", ".txt");

//            chooser.addChoosableFileFilter(restrect);
            ...
            File newfile = new File(saveas.getSelectedFile() + ".txt");
